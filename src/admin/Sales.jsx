        ...
        <Col lg="12">
          ...
          <div style={{visibility: select === "Dia" ? "visible" : "hidden"}} className="calendarWrap">
            ...
            <table className="table">
              ...
              <PDFDownloadLink document={<SalesPDF select={select} orders={select === "Dia" ? convertDaysFilter.length === 0 ? convertDays : convertDaysFilter : select === "Mes" ? convertMonth : convertYear} fileName="Ordenes.pdf"/>}><button style={{float: "right"}} className="btn btn-primary">Descargar Informe de Ventas</button></PDFDownloadLink>
          </div>
        </Col>
      </Row>
    </Container>
